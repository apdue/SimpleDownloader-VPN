...
public class FirstActivityNayaDownloader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (new PrefManagerVideoNayaDownloader(this).getString(SplashActivityNayaDownloader.dummy_one_screen).contains("ad")){
            ...
            rl.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    String url = new PrefManagerVideoNayaDownloader(FirstActivityNayaDownloader.this).getString(SplashActivityNayaDownloader.webview_url);
    ...
    private void startActivity(){
        Intent intent;
        if (new PrefManagerVideoNayaDownloader(FirstActivityNayaDownloader.this).getString(SplashActivityNayaDownloader.status_dummy_two_enabled).contains("true")) {
            intent = new Intent(FirstActivityNayaDownloader.this, SecondActivityNayaDownloader.class);
        } else if (new PrefManagerVideoNayaDownloader(FirstActivityNayaDownloader.this).getString(SplashActivityNayaDownloader.status_dummy_three_enabled).contains("true")) {
            intent = new Intent(FirstActivityNayaDownloader.this, ThirdActivityNayaDownloader.class);
        } else if (new PrefManagerVideoNayaDownloader(FirstActivityNayaDownloader.this).getString(SplashActivityNayaDownloader.status_dummy_four_enabled).contains("true")) {
