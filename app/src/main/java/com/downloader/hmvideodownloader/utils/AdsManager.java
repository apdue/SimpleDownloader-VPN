...
public class AdsManager {
    ...
    public static String id = "ali_vpnmaster";
...
//        }
    ...
    public static void showInterstitialAd(Activity activity, AdFinished adFinished) {
        ...
        if (prf.getString(SplashActivityNayaDownloader.interstitial_type).contains("admob")) {
            if (SplashActivityNayaDownloader.isConnectedToInternet(activity) && !new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN).contains("sandeep")) {

                if (adCount == prf.getInt(SplashActivityNayaDownloader.ADMOB_INTERSTITIAL_FREQUENCY)) {
                    adCount = 1;
                    if (new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.inter_ad_type).contains("inter")) {
                        showInter(activity, adFinished);
                    } else if (new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.inter_ad_type).contains("open")) {
                        OpenAdManagerSplashNayaDownloader.fetchAd(activity, adFinished);
                    } else if (new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.inter_ad_type).contains("both")) {
                        if (isOpen) {
        ...
        if (isInterstitialAdLoaded) {
            ...
            mInterstitialAd.setFullScreenContentCallback(new FullScreenContentCallback() {
                ...
                public void onAdImpression() {
                    ...
                    logInterstitialAdImpressionOnly(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN));
                }
            });
        } else {
            Log.d(TAG, "!showInterstitialAd: ");
            ...
            InterstitialAd.load(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN), new AdRequest.Builder().build(), new InterstitialAdLoadCallback() {
                @Override
    ...
    public static void loadInterstitialAd(Activity activity) {
        if (SplashActivityNayaDownloader.isConnectedToInternet(activity) && !new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN).contains("sandeep")) {
            if (!isInterstitialAdLoaded) {
                Log.d(TAG, "loadInterstitialAd: " + new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN));
                InterstitialAd.load(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_INTERSTITIALMAIN), new AdRequest.Builder().build(), new InterstitialAdLoadCallback() {
                    @Override
                    public void onAdFailedToLoad(@NonNull LoadAdError loadAdError) {
                        super.onAdFailedToLoad(loadAdError);
    ...
    public static void showAndLoadNativeAd(Activity activity, ViewGroup container, int size) {
        ...
        if (SplashActivityNayaDownloader.isConnectedToInternet(activity) && !new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEID).contains("sandeep")) {
            if (size == 0) {
                Log.d(TAG, "showAndLoadNativeAd: SMALL");

                AdLoader.Builder builder = new AdLoader.Builder(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEIDSMALL_fifteen));
                ...
                builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                            @Override
                            public void onPaidEvent(@NonNull AdValue adValue) {
                                logNativeAdImpression(activity, adValue, nativeAd, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEIDSMALL_fifteen));
                            }
                        });
                ...
                AdLoader adLoader = builder.withAdListener(new AdListener() {
                    ...
                    public void onAdImpression() {
                        ...
                        logNativeAdImpressionOnly(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEIDSMALL_fifteen));
                    }
                ...
                AdLoader.Builder builder = new AdLoader.Builder(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEID));
                ...
                builder.forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        ...
                        nativeAd.setOnPaidEventListener(new OnPaidEventListener() {
                            @Override
                            public void onPaidEvent(@NonNull AdValue adValue) {
                                logNativeAdImpression(activity, adValue, nativeAd, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEID));
                            }
                        });
                ...
                AdLoader adLoader = builder.withAdListener(new AdListener() {
                    ...
                    public void onAdImpression() {
                        super.onAdImpression();
                        logNativeAdImpressionOnly(activity, new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEID));
                    }
                ...
                Log.d(TAG, "showAndLoadNativeAd: LARGE" + new PrefManagerVideo(activity).getString(SplashActivityNayaDownloader.TAG_NATIVEID));
...
//            params.putString(FirebaseAnalytics.Param.AD_SOURCE, getAdSource(adView.getResponseInfo()));
    ...
    public static void logAppOpenAdImpression(Context context, AdValue adValue, AppOpenAd appOpenAd) {
        ...
        try {
            ...
            Log.d("TAGADEVENTS", "logAppOpenAdImpression: ");
    ...
    public static void logAppOpenAdImpressionOnly(Context context, String adUnitId) {
        ...
        try {
            ...
            Log.d("TAGADEVENTS", "logAppOpenAdImpressionOnly: ");
...
//            params.putString(FirebaseAnalytics.Param.AD_SOURCE, getAdSource(interstitialAd.getResponseInfo()));
    ...
    private static void logNativeAdImpression(Context context, AdValue adValue, NativeAd adView, String adUnitId) {
        ...
        try {
            ...
            if (adValue == null || adView == null || context == null) return;
            Log.d("TAGADEVENTS", "onPaidEvent: Native WORKS");
    ...
    private static void logNativeAdImpressionOnly(Context context, String adUnitId) {
        ...
        try {
            ...
            Log.d("TAGADEVENTS", "onAdImpression: Native WORKS");
